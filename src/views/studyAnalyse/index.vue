...
import {pythonrequest} from "../../apis/pythonrequest";
...
const loadPredictions = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get('/api1/api1/v1/predictions/');
...
const createPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.post('/api1/api1/v1/predictions/', newPredictionRequest.value);
...
const viewPrediction = async (id: string) => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/api1/api1/v1/predictions/${id}`);
    selectedPrediction.value = response.data;
...
const viewStudentPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/api1/api1/v1/predictions/${predictionId.value}/student/${studentId.value}`);
...
const viewClassPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/api1/api1//v1/predictions/${predictionId.value}/class/${classId.value}`);
