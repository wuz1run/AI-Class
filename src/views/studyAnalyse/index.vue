...
const loadPredictions = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get('http://40944903.r31.cpolar.top/api1/v1/predictions/');
...
const createPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.post('http://40944903.r31.cpolar.top/api1/v1/predictions/', {
...
const viewPrediction = async (id: string) => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`http://40944903.r31.cpolar.top/api1/v1/predictions/${id}`);
    selectedPrediction.value = response.data;
...
const viewStudentPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`http://40944903.r31.cpolar.top/api1/v1/predictions/${predictionId.value}/student/${studentId.value}`);
...
const viewClassPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`http://40944903.r31.cpolar.top/api1/v1/predictions/${predictionId.value}/class/${classId.value}`);
