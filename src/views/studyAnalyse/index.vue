...
const loadPredictions = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get('/cpolar-api/predictions/');
...
const createPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.post('/cpolar-api/predictions/', {
...
const viewPrediction = async (id: string) => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/cpolar-api/predictions/${id}`);
    selectedPrediction.value = response.data;
...
const viewStudentPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/cpolar-api/predictions/${predictionId.value}/student/${studentId.value}`);
...
const viewClassPrediction = async () => {
  ...
  error.value = '';
  try {
    const response = await axios.get(`/cpolar-api/predictions/${predictionId.value}/class/${classId.value}`);
